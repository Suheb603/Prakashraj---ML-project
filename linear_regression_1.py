...
print("="*80)
print("LINEAR REGRESSION MODEL FOR MEDICAL EQUIPMENT COST PREDICTION")
print("="*80)
...
# --- Reliability & service-based features ---
...
y_val_pred_log = lr_pipeline.predict(X_val_split)
...
# ============================================================================ #
# 8. FINAL TRAINING ON FULL DATA & PREDICTION
# ============================================================================ #
lr_pipeline.fit(X_train_clean, y_train_transformed)

y_test_pred_log = lr_pipeline.predict(X_test_clean)
...
submission.to_csv("linearregression_predictions_1.csv", index=False)

print("✅ Predictions saved as 'linearregression_predictions.csv'")
