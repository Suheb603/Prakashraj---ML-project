...
print("=" * 80)
print("GRADIENT BOOSTING MODEL FOR MEDICAL EQUIPMENT COST PREDICTION")
print("=" * 80)
...
# ========================================================================
# 5. GRADIENT BOOSTING MODEL PIPELINE
# ========================================================================
...
submission.to_csv("gradientboosting_predictions_1.csv", index=False)
print("\n✅ Predictions saved as 'gradientboosting_predictions.csv'")
print("=" * 80)
