...
print("="*80)
print("RANDOM FOREST MODEL FOR MEDICAL EQUIPMENT COST PREDICTION")
print("="*80)
...
combined_df['Heavy_Valuable'] = ((combined_df['Equipment_Weight'] > combined_df['Equipment_Weight'].median()) & 
                                 (combined_df['Equipment_Value'] > combined_df['Equipment_Value'].median())).astype(int)
...
X_train_split, X_val_split, y_train_split, y_val_split = train_test_split(
    X_train_clean, y_train_transformed, test_size=0.2, random_state=RANDOM_STATE
)
...
y_val_pred_log = rf_pipeline.predict(X_val_split)
y_val_pred = np.exp(y_val_pred_log)
y_val_true = np.exp(y_val_split)
...
# ============================================================================ #
# 7. FINAL TRAINING ON FULL DATA & PREDICTION
# ============================================================================ #
...
submission.to_csv("randomforest_predictions.csv", index=False)
print("✅ Predictions saved as 'randomforest_predictions.csv'")
